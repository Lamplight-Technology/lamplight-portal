      ...
      <main>
        ...
        >
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-400/30 rounded-full px-4 py-2 mb-8 backdrop-blur-sm">
              ...
              <span className="text-sm text-blue-200 font-medium">Careers</span>
            </div>
        ...
        <section className="py-20 md:py-28 bg-gradient-to-b from-white to-slate-50 relative">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 text-lg text-slate-600 leading-relaxed">
            <p>
              We're not running active recruiting right now, but we're always open to conversations
              with thoughtful people. If you're a builder who wants to work on software that serves
              the people using it — and who cares as much about how something is built as about
              whether it ships — reach out, even if it's just to introduce yourself.
            </p>
            <p>
              <strong className="text-lamplight-primary">What we look for:</strong> people who do
              what they say they'll do, communicate clearly, take ownership of outcomes, and treat
              customers and teammates with respect. Roles are typically across software
              engineering, AI/ML, product, and operations.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-slate-600 mb-10 max-w-2xl mx-auto">
              Send us a note through the contact form — pick "Careers" from the interest list —
